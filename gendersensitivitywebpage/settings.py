"""
Django settings for gendersensitivitywebpage project.
...
SECRET_KEY = 'django-insecure-o_ggt!b+axdjyhe!!qf$6+b@#3_d2h6@f56i9%)@*(51@w8aq8'
...
WSGI_APPLICATION = 'gendersensitivitywebpage.wsgi.application'
